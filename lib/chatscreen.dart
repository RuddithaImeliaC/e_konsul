      ...
      setState(() {
        ...
        databaseUser.forEach((key, value) {
          ...
          if (isUserDoctor == true) {
            if (user.nama_lengkap.toLowerCase().contains(search)) {
              listUser.add(user);
            }
          } else {
            listUser.add(user);
